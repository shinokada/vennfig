...
def complement(subs=1, size=15, fill_color='skyblue', bg_color='white', font_color='#000', font_size=20):
    """
    ...
    example
    complement()
    complement(subs=2, size=5, fill_color='#3eacb5', bg_color='#c1d9db', font_color='#d40f19', font_size=25)
    ...
    if subs == 1 or subs == 3:
        ...
        ax2.set_title("A'", fontsize=font_size)
